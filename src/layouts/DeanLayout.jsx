...
export default function DeanLayout() {
  ...
  const navLinks = [
    { name: 'Dashboard', path: '/dean', icon: <LayoutDashboard size={20} /> },
    { name: 'Tasks', path: '/dean/tasks', icon: <ListChecks size={20} /> },
    { name: 'Announcements', path: '/dean/announcements', icon: <Bell size={20} /> },
    { name: 'Meetings', path: '/dean/meetings', icon: <Calendar size={20} /> },
    { name: 'Messages', path: '/dean/messages', icon: <MessageSquare size={20} /> },
    { name: 'Official Memos', path: '/dean/memos', icon: <FileText size={20} /> },
  ];
      ...
      >
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50 flex items-center justify-between">
          <div className="truncate w-full pr-2">
            <p className="text-sm font-semibold truncate text-primary">{user?.name || 'Dean'}</p>
