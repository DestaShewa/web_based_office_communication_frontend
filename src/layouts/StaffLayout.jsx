...
export default function StaffLayout() {
  ...
  const navLinks = [
    ...
    { name: 'Tasks', path: '/staff/tasks', icon: <ListChecks size={20} /> },
    { name: 'Announcements', path: '/staff/announcements', icon: <Bell size={20} /> },
    { name: 'Meetings', path: '/staff/meetings', icon: <Calendar size={20} /> },
    { name: 'Messages', path: '/staff/messages', icon: <MessageSquare size={20} /> },
  ];
      ...
      >
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50 flex items-center justify-between">
          <div className="truncate w-full pr-2">
            <p className="text-sm font-semibold truncate text-primary">{user?.name || 'Staff'}</p>
